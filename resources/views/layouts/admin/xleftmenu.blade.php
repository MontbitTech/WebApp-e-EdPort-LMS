	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-8">
				...
				<a class="navbar-logo" href="./">e-DPort-i
	...
	<div class="left-accordion" id="parentAccordion">
		<div class="left-card">
			<div class="left-link {{ Request::segment(2) == 'dashboard'?'active':''}}"><a href="{{route('admin.dashboard')}}"><svg class="icon">
						<use xlink:href="{{asset('images/icons.svg#icon_teacher')}}"></use>
					</svg>Teacher</a></div>
		</div>

		<div class="left-card">
			<div class="left-link {{ Request::segment(2) == 'classes'?'active':''}}"><a href="{{route('admin.listClass')}}"><svg class="icon">
						<use xlink:href="{{asset('images/icons.svg#icon_listing')}}"></use>
					</svg>Classes</a></div>
		</div>

		<div class="left-card">
			<div class="left-link {{ Request::segment(1) == 'list-students'?'active':''}}"><a href="{{route('list.students')}}"><svg class="icon">
						<use xlink:href="{{asset('images/icons.svg#icon_listing')}}"></use>
					</svg>Student</a></div>
		</div>

		<div class="left-card">
			<div class="left-link {{ Request::segment(1) == 'list-timetable'?'active':''}}"><a href="{{route('list.timetable')}}"><svg class="icon">
						<use xlink:href="{{asset('images/icons.svg#icon_calendar')}}"></use>
					</svg>Time Table</a></div>
		</div>

		<div class="left-card">
			<div class="left-link {{ Request::segment(1) == 'list-topics'?'active':''}}"><a href="{{route('cms.listtopics')}}"><svg class="icon">
						<use xlink:href="{{asset('images/icons.svg#icon_listing')}}"></use>
					</svg>CMS Topics</a></div>
		</div>

		<div class="left-card">
			<div class="left-link {{ Request::segment(2) == 'support-help'?'active':''}}"><a href="{{route('admin.helplist')}}"><svg class="icon">
						<use xlink:href="{{asset('images/icons.svg#icon_support')}}"></use>
