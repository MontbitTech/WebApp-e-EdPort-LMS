...
@section('content')
    ...
    <link rel="stylesheet" type="text/css"
          href="https://cdn.datatables.net/v/bs4/dt-1.10.21/af-2.3.5/datatables.min.css"/>

    <script type="text/javascript"
            src="https://cdn.datatables.net/v/bs4/dt-1.10.21/af-2.3.5/datatables.min.js"></script>
    <section class="main-section">
        <div class="container">
            ...
            <div class="row" style="padding: inherit;padding-bottom: 2%;">
                <a href="javascript:getReport()" class="btn btn-ui float-right m-0 ">Generate Report</a>
            </div>
                        ...
                        <div class="card body pt-2">
                            ...
                            <table id="teacherlist" class="table table-sm table-bordered display" style="width:100%"
                                ...
                                <tr>
                                    ...
                                    <!-- <td></td> -->
                                    <td><a href="javascript:void(0);" data-INVLiveLink="{{ $g_link.'/gb' }}"
