                      ...
                      <div class="col-md-2 col-2 col-lg-2">
                          <div class="row">
                              <div class="col-7 col-md-7 col-lg-7 pt-1"> @if($t->cancelled)
                                  ...
                                  @endif</div>
                              <div class="col-5 col-md-5 col-lg-5"> <button type="button" class="btn mt-1 mb-1 btn-collapse text-white collapse-btn pl-2 pr-2 pt-1 pb-1 mb-1 mt-1" data-toggle="collapse" data-target="#collapseExample{{$t->id}}" aria-expanded="false" aria-controls="collapseExample{{$t->id}}"><i class="toggle-class  fas fa-plus"></i>
                                  </button></div>
                          </div>
