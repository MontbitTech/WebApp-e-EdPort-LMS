                ...
                <div class="col-sm-12">
                    <ul class="nav nav-tabs1 nav-pills" id="myTab" role="tablist">
                        <li class="nav-item mb-1">
                            <a class="nav-link shadow-sm active" data-toggle="tab" href="#ulclasses" role="tab"
                                aria-selected="true">Today's Live Classes</a>
                        </li>
                        <li class="nav-item mb-1">
                        ...
                        <li class="nav-item mb-1">
                            <a class="nav-link shadow-sm" data-toggle="tab" href="#newInvitationclasses"
                                role="tab">Assigned
                                Class</a>
                        </li>
                    ...
                    <div class="tab-content pt-3">
                        ...
                        ?>
                                    ...
                                    <div class="classes-box">
                                        ...
                                        <input type="hidden" id="txt_desc{{ $i }}"
                                            value="{{ $t->class_description }}">
                                        <input type="hidden" id="txt_gMeetURL{{ $i }}"
                                            value="{{ $teacherData->g_meet_url }}">
                                        <input type="hidden" id="txt_stdMessage{{ $i }}"
                                            value="{{ $t->class_student_msg }}">
                                        ...
                                        <div
                                            class="d-flex justify-content-between align-items-center flex-wrap pt-1 pb-2">
                                            <div class="font-weight-bold pt-1"><span
                                                    class="text-secondary">Class:</span>

                                                {{ $class_name }} Std

                                            </div>
                                            <div class="font-weight-bold pt-1"><span
                                                    class="text-secondary">Section:</span>
                                                {{ $section_name }}
                                            </div>


                                            <div class="font-weight-bold pt-1"><span
                                                    class="text-secondary">Subject:</span>
                                        ...
                                        <div class="text-editwrapper">
                                            <p class="mt-0 mb-2 text-secondary text-edit" data-url="#"
                                                data-savedesc="{{ $i }}" contenteditable="true"
                                                id="class_description_{{ $i }}" onchange="updateNote(this.value);">
                                        ...
                                        <div class="d-flex justify-content-between flex-wrap py-2">
                                            <div>
                                                <a href="javascript:void(0);"
                                                    data-LiveLink="{{ $teacherData->g_meet_url }}"
                                                    id="live_c_link_{{ $i }}"
                                                    class=" btn-sm btn-outline-success mb-1 mr-2 border-0 btn-shadow">
                                                ...
                                                <a href="#"
                                                    class=" btn-sm btn-outline-primary mb-1 mr-2 border-0 btn-shadow"
                                                    id="new_a_link_{{ $i }}" data-createModal='{{ $i }}'
                                                    data-class_modal="{{ $t->class_id }}"
                                                    data-subject_modal="{{ $t->subject_id }}"
                                                    data-teacher_modal="{{ $t->teacher_id }}">
                                    ...
                                    ?>
                                                <option value="">View Assigment</option><?php
                                                                                ...
                                                                                ?>
                                                <option value="{{ $key->g_live_link }}">{{ $key->g_title }}
                                                </option>
                                    ...
                                    ?>
                                                ...
                                                <a href="#"
                                                    class="btn btn-sm btn-outline-magenta mb-1 mr-2 border-0 btn-shadow"
                                                    data-notifyMe="{{ $i }}" data-id="notify_student"
                                                    id="notifyurl_{{ $i }}">
                                                    <svg class="icon mr-1">
                                            ...
                                            <div>
                                                <button type="button" data-classhelp="{{ $i }}"
                                                    class="btn btn-sm btn-outline-info mb-1 mr-2 border-0 btn-shadow"
                                                ...
                                                <button type="button" data-editModal="{{ $i }}"
                                                    class="btn btn-sm btn-outline-secondary mb-1 border-0 btn-shadow"
                                                    title="Edit">
                                                    <svg class="icon mr-1">
                            ...
                            ?>
                                        ...
                                        <div class="select-topicbox">
                                            <select class="form-control custom-select-sm border-0 btn-shadow"
                                                data-selecttopic="{{ $t->id }}">
                        ...
                        ?>
                                    ...
                                    <div class="classes-box">
                                        ...
                                        <input type="hidden" id="past_subject_id{{ $i }}"
                                            value="{{ $t->subject_id }}">

                                        <input type="hidden" id="past_desc{{ $i }}"
                                            value="{{ $t->class_description }}">
                                        <input type="hidden" id="past_gMeetURL{{ $i }}" value="{{ $t->g_meet_url }}">
                                        <input type="hidden" id="past_stdMessage{{ $i }}"
                                            value="{{ $t->class_student_msg }}">
                            ...
                            ?>
                                        ...
                                        <div
                                            ...
                                            <div class="font-weight-bold pt-1"><span
                                                    class="text-secondary">Section:</span> {{ $section_name }}
                                        ...
                                        <p class="mt-0 mb-2 text-secondary text-edit" data-url="#"
                                            data-savedesc="{{ $t->id }}" contenteditable="false"
                                            id="class_description_{{ $i }}">
                                            @if($t->class_description!='')
                                                {{ $t->class_description }}
                                            @else
                                                {{ $t->class_description }}
                                        ...
                                        <div class="d-flex justify-content-between flex-wrap py-2">
                                            <div>
                                                <a href="javascript:void(0);"
                                                    data-pastLiveLink="{{ $t->recording_url }}"
                                                    id="past_live_c_link_{{ $i }}"
                                                    class="btn btn-sm btn-outline-success mb-1 mr-2 border-0 btn-shadow">
                                                    <svg class="icon font-10 mr-1">
                                    ...
                                    $assignmentData = App\Http\Helpers\CommonHelper::get_assignment_data($t->id);
                                    ?>
                                                <select id="past_asslive_c_link_{{ $i }}"
                                                    class="btn btn-sm btn-outline-success mb-1 mr-2 border-0 btn-shadow"
                                                    data-passAssLiveLink="{{ $t->id }}" />
                                                <?php
                                    if (count($assignmentData) > 0) {
                                    ?>
						  ...
						  <a href="#" class="btn btn-sm btn-outline-magenta mb-1 mr-2 border-0 btn-shadow">
							...
							Help 
                                                ...
                                                <button type="button" data-pasteditModal="{{ $i }}"
                                                    class="btn btn-sm btn-outline-secondary mb-1 border-0 btn-shadow"
                                                    title="Edit">
                                                    <svg class="icon mr-1">
                                                        <use xlink:href="../images/icons.svg#icon_edit"></use>
                            ...
                            ?>
                                        ...
                                        <div class="select-topicbox">
                                            <select class="form-control custom-select-sm border-0 btn-shadow" disabled
                                                data-selecttopic="{{ $t->id }}">
                                                <option value="">Select Topic</option>
                                                @if(count($topics)>0)
                                                    @foreach($topics as $topic)
                                ...
                                ?>
                                            ...
                                            <a href="javascript:void(0);" data-pasttopiclink="{{ $cms_link }}"
                                                data-pasttopicid="{{ $t->topic_id }}"
                                                class="btn btn-outline-primary btn-sm btn-block mt-2 border-0 btn-shadow"
                                                id="pastviewcontent_{{ $t->id }}" style="{{ $display_style }}">
                                                View Content
                                            </a>
                                ...
                                <table id="teacherlist" class="table table-sm table-bordered display" style="width:100%"
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>{{ $section_name }}</td>
                                            <td>{{ $subject_name }}</td>
                                            <td><a href="javascript:void(0);" data-INVLiveLink="{{ $g_link }}"
                ...
                <div class="modal-body pt-4">
                    ...
                    <div class="form-group row">
                        <label for="inputAddquiz" class="col-md-4 col-form-label text-md-right"> Assignment Title
                            :</label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="txt_aTitle" id="txt_aTitle"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pt-4">
                    ...
                    ['add.class'],'method'=>'POST','autocomplete'=>'off','id'=>'frm_add_class')) !!}
                    <div class="form-group row">
                        <label for="addinputDate" class="col-md-4 col-form-label text-md-right">Date:</label>
                        <div class="col-md-6">
                            {!! Form::text('class_date', null, array('placeholder' => 'DD MM YYYY','class' =>
                            'form-control ac-datepicker','required'=>'required',"onkeydown"=>"return false;")) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="addinputFtime" class="col-md-4 col-form-label text-md-right">Class From
                            Time:</label>
                        <div class="col-md-6">
                            {!! Form::text('start_time', null, array('placeholder' => '00:00 AM/PM','class' =>
                            'form-control ac-time','required'=>'required',"onkeydown"=>"return false;")) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="addinputTtime" class="col-md-4 col-form-label text-md-right">Class To Time:</label>
                        <div class="col-md-6">
                            {!! Form::text('end_time', null, array('placeholder' => '00:00 AM/PM','class' =>
                            'form-control ac-time','required'=>'required',"onkeydown"=>"return false;")) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-12 text-danger text-center"
                            style="font-size: 12px;padding-left: 130px;">*Extra
                        ...
                        <div class="col-md-6">
                            ...
                            ?>
                                ...
                                <option value="<?= $row->id; ?>">
                                    <?= 'Class ' . $row->class_name . ' - ' . $row->section_name . ' - ' . $row->subject_name; ?>
                                </option>
                                <?php
                            }
				  ...
				  {!! Form::textarea('join_liveUrl', null, array('placeholder' => 'Enter Live class url','class' => 'form-control','required'=>'required','rows'=>'3')) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            {!! Form::textarea('notify_stdMessage', null, array('placeholder' => 'Enter Notify
                            Message','class' => 'form-control','required'=>'required','rows'=>'3')) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-8 offset-md-4">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pt-4">
                    ...
                    {!! Form::open(array('route' =>
                    ['edit.class'],'method'=>'POST','autocomplete'=>'off','id'=>'frm_class_edit')) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            {!! Form::textarea('edit_description', null, array('id'=>'edit_description','placeholder' =>
                            'Class Description','class' => 'form-control','required'=>'required','rows'=>'3')) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            {!! Form::textarea('edit_join_liveUrl',$teacherData->g_meet_url,
                            array('id'=>'edit_join_liveUrl','placeholder' => 'Enter Live class url','class' =>
                            'form-control','required'=>'required','rows'=>'3','disabled')) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputNotifystd" class="col-md-4 col-form-label text-md-right">Notify
                        ...
                        <div class="col-md-6">
                            ...
                            {!! Form::textarea('edit_notify_stdMessage', null,
                            array('id'=>'edit_notify_stdMessage','placeholder' => 'Enter Notify Message','class' =>
                            'form-control','required'=>'required','rows'=>'3')) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-8 offset-md-4">
                ...
                <div class="modal-body pt-4">
                    ...
                    <form>
                        ...
                        <div class="form-group row">
                            <label for="inputDesc" class="col-md-4 col-form-label text-md-right">Description:</label>
                            <div class="col-md-6">
                                {!! Form::textarea('past_edit_description', null,
                                array('id'=>'past_edit_description','placeholder' => 'Class Description','class' =>
                                'form-control','required'=>'required','rows'=>'3')) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="class_liveurl" class="col-md-4 col-form-label text-md-right"> Recording URL
                                <small>(Link)</small>:</label>
                            <div class="col-md-6">
                                {!! Form::textarea('past_edit_rec_liveUrl', null,
                                array('id'=>'past_edit_rec_liveUrl','placeholder' => 'Enter Recording Live url','class'
                                => 'form-control','required'=>'required','rows'=>'3')) !!}
                            </div>
                        </div>
                        <div class="form-group row">
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (response.status == 'success') {
                        ...
                        $('#past_live_c_link_' + id).attr('data-pastLiveLink', response
                            .rec_url);
                ...
                success: function (result) {
                    ...
                    if (response.status == 'success') {
                        ...
                        AssigmentData.forEach(function (val) {
                            ...
                            data +=
                                '<li> <a href="javascript:void(0);" onclick="give_assignment(\'' +
                                id + '\',\'' + val.g_live_link + '\',\'' + val.id +
                                '\',\'' + val.g_title + '\')" >' + val.g_title + '</a>';
                            data +=
                                ' ( <a  href="javascript:void(0);" data-viewAssignment="' +
                                val.g_live_link + '" > View </a>) </li>';

                        });

                        topics.forEach(function (val) {

                            topicData += '<option value="' + val.id + '">' + val.topicname +
                                '</option>';
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (response.status == 'success') {
                        ...
                        $.fn.notifyMe('success', 5, response.message);
                        $('#createAssiModal').modal('hide');
                        window.open(response.cource_url, "title",
                            "dialogWidth:400px;dialogHeight:300px");
                        var data = '<option value="' + response.cource_url + '">' +
                            assignment_title + '</option>';
                        $('#view_a_link_' + id).append(data);
                ...
                if (dateWork_id != '') {
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            $('#viewcontent_' + dateWork_id).attr('data-topiclink', response
                                .topic_link);
                            $.fn.notifyMe('success', 4, response.message);
                        },
                        error: function () {
                            $.fn.notifyMe('error', 4,
                                'There is some error while saving description text!');
                        }
                    });
                }
            } else {
            ...
            if (getDescText == '') {
                ...
                $.ajax({
                    ...
                    error: function () {
                        ...
                        $.fn.notifyMe('error', 4,
                            'There is some error while saving class note text!');
                    }
                });
            }
