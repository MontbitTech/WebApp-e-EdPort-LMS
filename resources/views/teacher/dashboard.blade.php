                                ...
                                <div class="row m-2">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="input-group text-editwrapper mt-1 mb-1">
                                            <textarea class="form-control text-edit1" rows="3" data-url="#" data-savedesc="{{$i}}" disabled contenteditable="true" id="class_description_{{$i}}">
                            ...
                            <div class="card-footer p-1" style="background:#fff;">
                                <div class="d-flex justify-content-between flex-wrap">
                                    ...
                                    <div class="m-auto">
                                        ...
                                        <button class="btn btn-sm btn-outline-primary mb-1 mr-2 border-0 btn-shadow">now Assigment</button>
