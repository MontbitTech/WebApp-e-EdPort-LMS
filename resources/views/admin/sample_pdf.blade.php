        ...
        <div class="card card-common mb-3">
          <div class="card-header">
            ...
            <div class="float-right">
               <a type="button" class="btn btn-sm btn-success" href="{{route('admin.downloadPDF')}}">
                <svg class="icon icon-font16 icon-mmtop-3 mr-1"><use xlink:href="{{asset('images/icons.svg#icon_adduser')}}"></use></svg> downloadPDF
              </a> 
            </div>
          </div>
