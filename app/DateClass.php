...
class DateClass extends Model
{
    ...
    protected $fillable = ['class_id', 'subject_id', 'teacher_id', 'topic_id', 'from_timing', 'to_timing', 'cancelled', 'class_date', 'timetable_id', 'live_link', 'ass_live_url', 'quiz_link', 'is_past', 'class_student_msg', 'class_description', 'g_meet_url', 'recording_url'];
    ...
    {
        return $this->where('cancelled', 1);
    }

    public function attendance ()
    {
        return $this->hasMany(Attendance::class,'dateclass_id');
    }
}
