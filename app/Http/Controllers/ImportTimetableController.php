												...
												if($resData['error']['status'] == 'UNAUTHENTICATED')
													{
														...
														Log::error('Class has not create in Google ClassRoom for ROW - ' .$period_name.' ERROR :'.$resData['error']['message']	);
														$error = "found";
														$rows_period .= $period_name . ",";
														$error_msg = 'Class has not create in Google ClassRoom for ROW - ' .$period_name.' ERROR :'.$resData['error']['message'];
													}
											}
											else
											{
