        ...
        if ($request->isMethod('post')) {
            ...
            if ($responce == 101) {
                ...
                if ($resData['error']) {
                    ...
                    $message = "Your school created an account for you. Gmail ID: $email and use t# followed by phone number as password..";
                        ...
                        if ($TeacherExist) {
                            ...
                            if ($responce == 101) {
                                ...
                                if ($resData['error']) {
                                    ...
                                    Log::info(Config::get('constants.WebMessageCode.100') . " : ROW - " . $i);
                                }
                            }
                        }
                    }
